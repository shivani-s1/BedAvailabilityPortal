...
class AdminHospitalApplicationTests {
	...
	/*
	 * @Test public void saveAdminHospital(){ Hospital hospital=Hospital.builder()
	 * .hId(12L) .hName("KIMS") .hNumber("9876543278")
	 * .hAddress("Rajahmundry Main Road 533241") .hState("AP") .hCity("Rajahmundry")
	 * .hType("Government") .build(); adminHospitalRepository.save(hospital);
